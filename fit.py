...
parser.add_argument('--lr-step-size', default=20, type=int, help='learning rate decay step size')
...
def main():
    ...
    trainer.fit(model, train_dataloaders=data.training_loader, ckpt_path="last" if args.ckpt_load else None)
