...
class HMDB51DataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.test_dataset = HMDB51Dataset(self.cfg.root, "2", train=False, transform=self.test_transform)

    def train_dataloader(self):
        return DataLoader(self.train_dataset, batch_size=self.cfg.batch_size, shuffle=not self.cfg.debug,
